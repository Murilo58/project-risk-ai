  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage: "linear-gradient(135deg, #1e3a8a 0%, #172554 60%, #0f172a 100%)",
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          Calcula automaticamente a saúde de projetos de TI e usa IA para identificar
          riscos ainda não cadastrados, com causa e mitigação sugerida.
        </div>
      </div>
